...
#Region "Painting"
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If _ShowFocus AndAlso Me.Focused Then ControlPaint.DrawFocusRectangle(g, New Rectangle( _
            2 + CInt(Not _BorderShow), 2 + CInt(Not _BorderShow), _
                Me.Width - ((2 + CInt(Not _BorderShow)) * 2), _
                Me.Height - ((2 + CInt(Not _BorderShow)) * 2)), Color.Black, Me.BackColor)
    End Sub
            ...
            With rectSlider
                If Orientation = Windows.Forms.Orientation.Horizontal Then
                    ...
                    Select Case _ValueBox
                        Case eValueBox.None
                            .X = 17 + intSlideIndent
                            .Width = Me.Width - 35 - (intSlideIndent * 2)
                        Case eValueBox.Left
                            rectValueBox.X = 18
                            rectValueBox.Y = CInt(((rectSlider.Height - rectValueBox.Height) / 2))
                            .Width = CInt(Me.Width - 35 - rectValueBox.Width - _
                                (intSlideIndent * 2) - (_SliderWidth / 2))
                            .X = CInt(rectValueBox.Width + 17 + intSlideIndent + (_SliderWidth / 2))
                        Case eValueBox.Right
                            rectValueBox.X = Me.Width - 19 - rectValueBox.Width
                            rectValueBox.Y = CInt(((rectSlider.Height - rectValueBox.Height) / 2))
                            .Width = CInt(Me.Width - 35 - rectValueBox.Width - _
                                (intSlideIndent * 2) - (_SliderWidth / 2))
                            .X = 17 + intSlideIndent
                ...
                Else
                    Select Case _ValueBox
                        Case eValueBox.None
                            .Y = 17 + intSlideIndent
                            .Height = Me.Height - 35 - (intSlideIndent * 2)
                        Case eValueBox.Left
                            rectValueBox.X = CInt(((rectSlider.Width - rectValueBox.Width) / 2))
                            rectValueBox.Y = 18
                            .Height = CInt(Me.Height - 35 - rectValueBox.Height - (intSlideIndent * 2))
                            .Y = CInt(rectValueBox.Height + 17 + intSlideIndent)
                        Case eValueBox.Right
                            rectValueBox.X = CInt(((rectSlider.Width - rectValueBox.Width) / 2))
                            rectValueBox.Y = Me.Height - 19 - rectValueBox.Height
                            .Height = CInt(Me.Height - 35 - rectValueBox.Height - (intSlideIndent * 2))
                            .Y = 17 + intSlideIndent
                    End Select
                    If _LabelShow Then
